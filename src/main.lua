...
function love.load()
    ...
    Font.CreateFont("UILarge", "assets/fonts/SourceSansPro-Regular.ttf", 32)
    Font.CreateFont("UIMedium", "assets/fonts/SourceSansPro-Regular.ttf", 24)
    Font.CreateFont("UISmall", "assets/fonts/SourceSansPro-Regular.ttf", 18)

    Font.CreateFont("UILargeB", "assets/fonts/SourceSansPro-Bold.ttf", 32)
